...
An interactive website that lets you travel through different years of the internet and explore how the web changed over time.

🚀 About the Project

Internet Time Machine is a beginner-friendly web project made with:

- HTML
- CSS
- JavaScript

The idea is simple: choose a year and travel back in time to see what the internet was like during that era.

Currently, the project includes years from 1995 to 2026.

✨ Features

- 🕰️ Select different years
